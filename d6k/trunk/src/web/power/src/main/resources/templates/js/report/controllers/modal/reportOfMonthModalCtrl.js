...
DaQOCloud.controller('reportOfMonthModalCtrl',['$scope','$http','$rootScope','$filter','realtimeCurveService',function($scope, $http, $rootScope,$filter,realtimeCurveService) {
