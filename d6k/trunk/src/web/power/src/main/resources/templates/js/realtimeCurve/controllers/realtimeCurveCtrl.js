...
DaQOCloud.controller('realtimeCurveCtrl',['$scope','$stateParams','$state','realtimeCurveService', function ($scope, $stateParams, $state, realtimeCurveService) {
    ...
    realtimeCurveService.getStationInfo().then(function (result) {
