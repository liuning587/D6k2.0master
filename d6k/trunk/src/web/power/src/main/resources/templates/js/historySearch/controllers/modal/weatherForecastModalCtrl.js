...
DaQOCloud.controller('weatherForecastModalCtrl',['$scope','$http','$rootScope','$filter','realtimeCurveService',function($scope, $http, $rootScope,$filter,realtimeCurveService) {
