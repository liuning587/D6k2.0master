...
public:
	CServerDB( );
	explicit CServerDB(CScadaApi *pScada);
...
private:
	...
	bool SetUserVarValue(int32u nOccNo, IO_VARIANT *pData,int32u nSrcAppOccNo, void *pExt);
	bool SetSysVarValue(int32u nOccNo, IO_VARIANT *pData, int32u nSrcAppOccNo, void *pExt);
