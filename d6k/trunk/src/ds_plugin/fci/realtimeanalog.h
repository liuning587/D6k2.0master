...
public:
    ...
    CRealTimeAnalog(QWidget *parent, CCommThread *pCommunicate, CPointInfo *pPointInfo, CFciFile *pChooseWgt, CInfoConfigWgt *pConfgWgt);
	~CRealTimeAnalog();
...
private:
	...
	//id item
	std::unordered_map<int, QStandardItem*>m_mapIdItemObj;
