...
class FCISHARED_EXPORT CFtuModule : public IPluginModule
{
	Q_OBJECT
public:
    CFtuModule();
...
public:
	...
	//syspara
	CSysParaWgt * m_pSysParaWgt;

	CUartPara * m_pUartParaWgt;

	CGprsPara * m_pGprsParaWgt;

	CGpsPara * m_pGpsParaWgt;

	CSmsPara * m_pSmsParaWgt;

	CProtocolPara * m_pProtocolParaWgt;
};
