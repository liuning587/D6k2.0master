...
** \note
********************************************************************************************************/
int CDecodeCache::GetDataLen()
{
	ASDUADDR2* lengthByte = (ASDUADDR2*)(m_buf+1);
	return lengthByte->GetAddr() + 6;
}

int CDecodeCache::GetCurByteLength()
{
	return m_nCurPos;
}
...
** \note
********************************************************************************************************/
int CDecodeCache::GetNeedByteLength()
{
	//获取一包104的长度
	int nDataLen = GetDataLen();
	if (nDataLen <= 0)
...
** \note
********************************************************************************************************/
void CDecodeCache::CopyData(char* pBuff, int nLen)
{
	char* pFrom = m_buf + m_nCurPos;
